function Minesweeper(A, Q, s) {
  ...
  function V() {
    ...
    Z.push(
      ...
      '<div class="facesmile" style="margin-left:',
      Math.floor(aa),
      "px; margin-right: ",
      Math.ceil(aa),
      'px;" id="face"></div>',
    ...
    for (Y = 0; Y <= a + 1; Y++) {
      Z.push(
        '<div class="square blank" style="display: none;" id="',
        0,
        "_",
        Y,
        '"></div>'
  ...
  function H(ab, ae) {
    ...
    if (ae) {
      Z = prompt(
        U.getTime() + " is a new " + Y + " high score! Please enter your name",
        ac
      );
    } else {
      Z = prompt(
        "Please enter your name to submit your score (" + U.getTime() + ")",
        ac
      );
    }
    ...
    $.post(
      "win.php",
      { key: r, name: Z, time: U.getTime(), s: ad, i: ab, h: ae ? 1 : 0 },
      function (af) {
  ...
  function P() {
    ...
    function ad(ag) {
      ...
      var af = Y(ag);
      document.getElementById("face").className =
        af.id == "face" ? "facepressed" : "facesmile";
    }
    function Y(af) {
